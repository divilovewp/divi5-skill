...
**V0.6.3 — Builder Version 5.9.0** (tracks the Divi 5.8.x–5.9.x line). The
...
v0.6.3 adds the Divi 5.9.0 **Grid Editor** (`gridOffsetRules` — container-driven
per-item placement; LAYOUT §5b) and rolls up doc improvements (an "avoid AI-design
clichés" section, render-verified community gotchas). v0.6.0 added the **Tooltip
module** + the **Advanced Text Styling** batch. See `DIVI5-COVERAGE.md` for what is
