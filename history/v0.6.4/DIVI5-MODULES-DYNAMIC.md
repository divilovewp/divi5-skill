...
### `divi/post-content`
Renders the current post body. Minimal — no required attrs: `{"builderVersion": "5.9.0"}`. Only meaningful inside a single template.
...
*DIVI5 Dynamic Modules Skill — V0.6.3 | Builder Version 5.9.0 | Created by Shashank Gupta @ divilove.com*
